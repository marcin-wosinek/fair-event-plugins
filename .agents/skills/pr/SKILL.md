---
name: pr
description: Turn the current Fair Event Plugins working-tree changes into a formatted, verified commit on a topic branch and open a pull request.
---
...
Push and create the PR with a temporary body file. Include Summary and Test plan, plus Notes when relevant. Remove the temporary file, do not add AI attribution, and report the PR URL.
