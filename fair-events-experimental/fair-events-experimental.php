 ...
 * Description: Activates advanced feature bundles for Fair Events, including galleries, sources, ticketing, duplicate and merge tools, and migration. Requires fair-events.
 * Version: 1.6.0
...
add_action(
	...
	function () {
		...
		define( 'FAIR_EVENTS_EXPERIMENTAL_VERSION', '1.6.0' );
