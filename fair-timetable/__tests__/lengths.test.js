...
describe( 'LengthOptions.formatLengthLabel', () => {
	...
	test( 'should round minutes correctly', () => {
		...
		expect( LengthOptions.formatLengthLabel( 0.083333 ) ).toBe(
			'5 minutes'
		); // 5 minutes (1/12 hour)
	} );
	...
	test( 'should handle decimal precision correctly', () => {
		...
		expect( LengthOptions.formatLengthLabel( 0.333333 ) ).toBe(
			'20 minutes'
		);
		expect( LengthOptions.formatLengthLabel( 0.666667 ) ).toBe(
			'40 minutes'
		);
	} );
