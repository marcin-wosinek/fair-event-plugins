...
declare -A mappings=(
    ["src/Admin/events/EventsList.js"]="build/admin/events/index.js"
)
...
for lang in de_DE es_ES fr_FR pl_PL; do
    ...
    for source in "${!mappings[@]}"; do
        ...
        source_file="build/languages/fair-rsvp-${lang}-${source_hash}.json"
        target_file="build/languages/fair-rsvp-${lang}-${build_hash}.json"
