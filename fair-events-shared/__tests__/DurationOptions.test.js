...
describe( 'DurationOptions.formatDurationLabel', () => {
	test( 'should format hours unit correctly', () => {
		...
		expect( DurationOptions.formatDurationLabel( 2, 'hours' ) ).toBe(
			'2 hours'
		);
	} );
	...
	test( 'should format days unit correctly', () => {
		expect( DurationOptions.formatDurationLabel( 1, 'days' ) ).toBe(
			'1 day'
		);
		expect( DurationOptions.formatDurationLabel( 3, 'days' ) ).toBe(
			'3 days'
		);
	} );
