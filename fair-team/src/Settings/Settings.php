<?php
/**
 * Settings for Fair Team
 *
 * @package FairTeam
 */

namespace FairTeam\Settings;
...
class Settings {
	...
	public function init() {
		...
		add_action( 'add_option_fair_team_slug', array( $this, 'flush_rewrite_rules_on_slug_change' ), 10, 2 );
		add_action( 'update_option_fair_team_slug', array( $this, 'flush_rewrite_rules_on_slug_change' ), 10, 2 );
		add_action( 'delete_option_fair_team_slug', array( $this, 'flush_rewrite_rules_on_slug_change' ) );
	...
	public function register_settings() {
		// Register team member slug setting
		register_setting(
			'fair_team_settings',
			'fair_team_slug',
			array(
				'type'              => 'string',
				'description'       => __( 'URL slug for team members', 'fair-team' ),
	...
	/**
	 * Flush rewrite rules when team member slug changes
	 *
