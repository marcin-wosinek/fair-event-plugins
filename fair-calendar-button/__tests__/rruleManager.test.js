...
describe( 'RRuleManager', () => {
	...
	describe( 'formatUntilDate', () => {
		it( 'should format valid YYYY-MM-DD date', () => {
			...
			expect( manager.formatUntilDate( '2024-01-01' ) ).toBe(
				'20240101'
			);
			expect( manager.formatUntilDate( '2024-06-15' ) ).toBe(
				'20240615'
			);
		} );
		...
		it( 'should format strings that become 8 digits after removing hyphens', () => {
			...
			expect( manager.formatUntilDate( '31-12-2024' ) ).toBe(
				'31122024'
			);
			expect( manager.formatUntilDate( '2024-13-01' ) ).toBe(
				'20241301'
			); // Invalid month but 8 digits
			expect( manager.formatUntilDate( '2024-12-32' ) ).toBe(
				'20241232'
			); // Invalid day but 8 digits
		} );
	...
	describe( 'exported instance', () => {
		...
		it( 'should work the same as a new instance', () => {
			...
			const events1 = rruleManager.generateEvents(
				uiState,
				'2024-01-01'
			);
