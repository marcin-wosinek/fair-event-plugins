...
This document describes the Mollie payment integration in the Fair Payments Connector plugin.
...
2. **REST API Endpoints** (`src/API/`)
   - `POST /wp-json/fair-payments-connector/v1/payments` - Creates a payment
   - `POST /wp-json/fair-payments-connector/v1/webhook` - Handles Mollie webhooks
...
- Mollie sends webhook notification to `/wp-json/fair-payments-connector/v1/webhook`
...
- **Pretty Permalinks**: `https://example.com/wp-json/fair-payments-connector/v1/payments`
- **Plain Permalinks**: `https://example.com/?rest_route=/fair-payments-connector/v1/payments`
