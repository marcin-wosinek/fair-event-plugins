...
// DOM id for the wrapper only. Must NOT reuse $block_id: the endpoint matches
// the saved blockId attribute in post content, so the button has to submit
// the attribute value, not a per-render unique id.
