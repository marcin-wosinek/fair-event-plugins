...
class Event {
	...
	private static function register_post_type() {
		$labels = array(
			'name'                  => _x( 'Event Pages', 'Post type general name', 'fair-events' ),
			'singular_name'         => _x( 'Event Page', 'Post type singular name', 'fair-events' ),
			// Not translatable - "Fair Events" is the brand name.
			'menu_name'             => 'Fair Events',
			'name_admin_bar'        => _x( 'Event Page', 'Add New on Toolbar', 'fair-events' ),
			'add_new'               => __( 'Add New', 'fair-events' ),
			'add_new_item'          => __( 'Add New Event Page', 'fair-events' ),
			'new_item'              => __( 'New Event Page', 'fair-events' ),
			'edit_item'             => __( 'Edit Event Page', 'fair-events' ),
			'view_item'             => __( 'View Event Page', 'fair-events' ),
			'all_items'             => __( 'Event Pages', 'fair-events' ),
			'search_items'          => __( 'Search Event Pages', 'fair-events' ),
			'parent_item_colon'     => __( 'Parent Event Pages:', 'fair-events' ),
			'not_found'             => __( 'No event pages found.', 'fair-events' ),
			'not_found_in_trash'    => __( 'No event pages found in Trash.', 'fair-events' ),
			...
			'archives'              => _x( 'Event page archives', 'The post type archive label', 'fair-events' ),
			...
			'filter_items_list'     => _x( 'Filter event pages list', 'Screen reader text for the filter links', 'fair-events' ),
			'items_list_navigation' => _x( 'Event pages list navigation', 'Screen reader text for the pagination', 'fair-events' ),
			'items_list'            => _x( 'Event pages list', 'Screen reader text for the items list', 'fair-events' ),
		);
