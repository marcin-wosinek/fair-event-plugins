...
signUpButton.onclick = async () => {
	...
	document
		.getElementById( 'creating-connected-account' )
	...
	fetch( '/account.php', {
		...
		.then( ( json ) => {
			...
			const connectedAccountIdElement = document.getElementById(
			...
			document
				.getElementById( 'add-information-button' )
				.classList.remove( 'hidden' );
			document
				.getElementById( 'creating-connected-account' )
				.classList.add( 'hidden' );
			...
			document
				.getElementById( 'add-information-title' )
				.classList.remove( 'hidden' );
			document
				.getElementById( 'add-information-subtitle' )
				.classList.remove( 'hidden' );
		} );
};
...
const createAccountLinkAndRedirect = async () => {
	document
		.getElementById( 'adding-onboarding-information' )
		.classList.remove( 'hidden' );
	document.getElementById( 'error' ).classList.add( 'hidden' );
	document
		.getElementById( 'add-information-button' )
...
const addInformationButton = document.getElementById(
...
if ( route === 'return' ) {
	...
	document.getElementById( 'sign-up-button' ).classList.add( 'hidden' );
	document
		.getElementById( 'details-submitted-title' )
		.classList.remove( 'hidden' );
	document
		.getElementById( 'details-submitted-subtitle' )
		.classList.remove( 'hidden' );
